...
这是一个零依赖的静态单页官网原型，当前重点是先确认首页里的产品、案例和联系方式三个内容区块的结构与展示方式。

## 页面说明

- `index.html`: 单页首页，包含产品、案例和联系方式区块
- `404.html`: 404 页面
...
- `main.js`: 占位联系方式注入、移动端导航、滚动显现和首页锚点导航交互
- `favicon.svg`: 站点图标
...
这套结构适合当前的纯静态单页站直接发布到 GitHub Pages。
